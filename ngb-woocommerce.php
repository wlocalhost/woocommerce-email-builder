...
function ngb_woocommerce_add_files()
{
    ...
    wp_register_script('ngb_main', plugins_url('js/ngb/main.js', __FILE__), '', '1.1', true);
    wp_enqueue_script('ngb_main');

    wp_register_script('ngb_polyfills', plugins_url('js/ngb/polyfills.js', __FILE__), '', '1.1', true);
    wp_enqueue_script('ngb_polyfills');

    wp_register_script('ngb_runtime', plugins_url('js/ngb/runtime.js', __FILE__), '', '1.1', true);
